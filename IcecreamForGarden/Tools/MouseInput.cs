...
{
    /// <summary>
    /// You can see <see href="https://stackoverflow.com/questions/8272681/how-can-i-simulate-a-mouse-click-at-a-certain-position-on-the-screen">source of code</see>.
    /// </summary>
    public class MouseInput
    {
        ...
        {
            //DoMouse(NativeMethods.MOUSEEVENTF.MOVE | NativeMethods.MOUSEEVENTF.ABSOLUTE, new Point(x, y));
            DoMouse(NativeMethods.MOUSEEVENTF.LEFTDOWN, new Point(x, y));
            DoMouse(NativeMethods.MOUSEEVENTF.LEFTUP, new Point(x, y));
        }
        ...
        {
            DoMouse(NativeMethods.MOUSEEVENTF.RIGHTDOWN, new Point(0, 0));
            DoMouse(NativeMethods.MOUSEEVENTF.RIGHTUP, new Point(0, 0));
        }

        public static void RightClick(int x, int y)
        {
            DoMouse(NativeMethods.MOUSEEVENTF.MOVE | NativeMethods.MOUSEEVENTF.ABSOLUTE, new Point(x, y));
            DoMouse(NativeMethods.MOUSEEVENTF.RIGHTDOWN, new Point(x, y));
            DoMouse(NativeMethods.MOUSEEVENTF.RIGHTUP, new Point(x, y));
        }
        ...
        {
            DoMouse(NativeMethods.MOUSEEVENTF.WHEEL, new Point(0, 0), scrollSize);
        }
